...
public class FilmHandler {
    ...
    public Mono<ServerResponse> getById(ServerRequest serverRequest){
        ...
        return ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body(service.getById( id ), FilmDTO.class);
    }
    ...
    public Mono<ServerResponse> getByManyIds(ServerRequest serverRequest){
        ...
        return ServerResponse.ok().contentType(MediaType.APPLICATION_JSON).body( service.getByManyIds(idList) , FilmDTO.class );
    }
